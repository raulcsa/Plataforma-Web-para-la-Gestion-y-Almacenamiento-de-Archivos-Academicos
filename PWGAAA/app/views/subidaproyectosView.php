...
<head>
  ...
  <style>
    /* Forzar altura completa para html y body */
    html, body {
      height: 100%;
    }
    /* Body como flex container para empujar el footer */
    body {
      display: flex;
    ...
    /* Navbar: reutilizamos el estilo de las otras páginas */
    .navbar {
...
<body>
  <!-- Navbar (igual que en las demás páginas) -->
